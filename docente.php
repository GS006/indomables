...
<body>
    ...
    <div class="container mt-4">
        <h1 class="text-center color-red">TABLA DOCENTE</h1>
        <table class="table text-white mt-3 mb-5 border-bottom">
            ...
            <tbody>
                ...
                //CONSULTAR TABLA
                $consulta1 = "select * from tdocente where CodDocente like '$codigo'";
                ...
                ?>
                    <tr>
                        <td><?php echo $fila['CodDocente'] ?></td>
     ...
     <div class="container mt-4">
        <h1 class="text-center color-red">TABLA CARGA</h1>
        <table class="table text-white mt-3 mb-5 border-bottom">
            <thead>
                <tr>
                    <th scope="col">ID</th>
            ...
            <tbody>
                ...
                //CONEXION A UNA BBDD
                mysqli_select_db($link, 'byhuiujzlldacrbsbnwq');
                $consulta1 = "select * from tcarga where CodDocente like '$codigo'";
